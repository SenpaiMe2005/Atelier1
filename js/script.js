        ...
        // Functie om de modal te verbergen en een actie uit te voeren bij bevestigen
        document.addEventListener('DOMContentLoaded', () => {
            ...
            confirmSendButton.addEventListener('click', function() {
                ...
                alert('Formulier verzonden!'); // Hier kan je eigen logic implementeren
            });
        });

        // Functie om een draaiende SVG-animatie te implementeren (optioneel)
